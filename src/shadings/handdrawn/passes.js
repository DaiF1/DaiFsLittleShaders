...
export function loadHanddrawnShading(scene, mainCamera, sunDir) {
    if (renderGraph != null)
        return;
    ...
    const crosshatching = new Texture("./resources/crosshatching.png");
    ...
    let renderPass = new RenderPass(scene,
        new Shader(renderVert, renderFrag),
        {
            ...
            uniforms: [
                ...
                { name: 'u_crossHatching', type: 't', value: crosshatching },
            ],
            out: {
...
export function renderHanddrawnShading(elapsedTime) {
