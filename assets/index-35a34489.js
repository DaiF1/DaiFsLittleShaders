...
}`;let st=null;function ae(i,e,o){if(st!=null)return;const r=2048,n=new k(J,{size:[r,r],compareMode:!0,filter:"linear"}),a=Et(o),c=40,l=[a[0]*c,a[1]*c,a[2]*c],f=Math.abs(a.y)>.99?[1,0,0]:[0,1,0],u=c*1.2;let s=new lt(Z,{position:l,target:[0,0,0],up:f,near:.1,far:c*4,left:-u,right:u,top:-u,bottom:u}),h=new X(i,new G(wt,Rt),{renderSize:[r,r],camera:s,out:{depth:n},cullface:"front"});const m=new B("./resources/vanilla-milkshake-1x.png"),v=new k(nt),g=new k(nt,{wrap:"clamp"}),p=new k(J,{wrap:"clamp"});let _=new X(i,new G(oe,ie),{camera:e,uniforms:[{name:"u_shadow",type:"t",value:n},{name:"u_palette",type:"t",value:m},{name:"u_shadowViewProj",type:"m4",value:s.viewProjMatrix}],out:{colors:[v,g],depth:p}}),E=new X(tt.getPostProcessPlane(),new G(re,ne),{camera:e,uniforms:[{name:"u_color",type:"t",value:v},{name:"u_normal",type:"t",value:g},{name:"u_depth",type:"t",value:p}]});st=new bt([h,_,E])}function se(){st.render()}async function ce(){Pt();const i=new rt(await j.fromOBJ("./resources/planet.obj"),[-11,-36,0]),e=new rt(await j.fromOBJ("./resources/car.obj"),[8,-1.5,0],[0,0,-N(29)]),o=[-2,5,-6],r=new tt([e,i],{directional:[{direction:o,color:[1,.8,.6],intensity:1}],point:[{position:[9.6,-3,.78],color:[1,0,0],intensity:.3},{position:[9.6,-3,-.78],color:[1,0,0],intensity:.3},{position:[5.3,-.5,.7],color:[1,1,0],intensity:.7},{position:[5.3,-.5,-.7],color:[1,1,0],intensity:.7}]}),n=new lt(it),a={pbr:{load:te,render:ee},scientific:{load:ae,render:se}};let c="pbr";document.body.classList=c;let l=!1;Ft({cameraCallback:()=>{l=!l;const s=l?[45,30,55]:[35,0,0],h=l?[-5,0,0]:[0,0,0];n.moveCamera(s,h)},shadingCallback:s=>{c=s,a[c].load(r,n,o),document.body.classList=s}}),a[c].load(r,n,o);let f=0;function u(s){s*=.001;let h=s-f;i.rotateZ(-10*h),n.update(h),f=s,a[c].render(),requestAnimationFrame(u)}requestAnimationFrame(u)}ce();
